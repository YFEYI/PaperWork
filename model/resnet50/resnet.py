...
class ResNet(nn.Module):
    def __init__(self,block,blocks_num,num_classes,
        ...
        #[B,7680,9,9]->[B,64,8,8]
        #self.conv1=nn.Conv2d(768,self.in_channel,kernel_size=4,stride=1,padding=1,bias=False)
        # [B,7680,9,9]->[B,64,8,8]
        self.conv1=nn.Conv2d(768,self.in_channel,kernel_size=4,stride=1,padding=5,bias=False)
        self.bn1=nn.BatchNorm2d(self.in_channel)
        self.relu=nn.ReLU()
        # [B,64,8,8]->[B,64,4,4] 本身就不大的面积雪上加霜
